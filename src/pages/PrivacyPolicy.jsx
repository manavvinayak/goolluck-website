...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 text-gray-800">
      <h1 className="text-4xl md:text-6xl font-bold text-center text-black mb-4">
        Privacy <span>Policy</span>
      </h1>
      
      <section className="mb-6">
        <h2 className=" text-2xl md:text-4xl font-semibold mb-3 text-secondary">1. Introduction</h2>
      ...
      <section className="mb-6">
        <h2 className=" font-semibold  mb-2 md:text-3xl text-2xl text-secondary">2. Information We Collect</h2>
      ...
      <section className="mb-6">
        <h2 className=" font-semibold md:text-3xl text-2xl mb-2 text-secondary">3. How We Use Your Information</h2>
        <ul className="list-disc list-inside md:text-2xl text-xl">
      ...
      <section className="mb-6">
        <h2 className="md:text-3xl text-2xl font-semibold  mb-2 text-secondary ">4. Data Sharing and Security</h2>
        <p className="md:text-2xl text-xl">
      ...
      <section className="mb-6">
        <h2 className="md:text-3xl text-2xl font-semibold  mb-2 text-secondary">5. Your Rights and Choices</h2>
        <ul className="list-disc list-inside md:text-2xl text-xl">
      ...
      <section className="mb-6">
        <h2 className="md:text-3xl text-2xl font-semibold  mb-2 text-secondary">6. Third-Party Links</h2>
        <p className="md:text-2xl text-xl">
      ...
      <section className="mb-6">
        <h2 className="md:text-3xl text-2xl font-semibold  mb-2 text-secondary">7. Changes to This Policy</h2>
        <p className="md:text-2xl text-xl">
      ...
      <section className="mb-6">
        <h2 className="md:text-3xl text-2xl font-semibold  mb-2 text-secondary">8. Contact Us</h2>
        <p className="md:text-2xl text-xl">
          If you have any questions or concerns regarding this Privacy Policy, please contact us at:
        </p>
        <p className="mt-4 font-semibold md:text-3xl text-2xl mb-4">GOOLLUCK <span>INVESTMENTS</span></p>
